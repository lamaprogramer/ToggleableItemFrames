...
public class UseEntityHandler implements UseEntityCallback {
    ...
    public ActionResult interact(PlayerEntity player, World world, Hand hand, Entity entity, @Nullable EntityHitResult hitResult) {
        ...
        if (entity instanceof ItemFrameEntity && hitResult != null && !player.isSpectator() && !world.isClient() && world.getServer() != null && player.getMainHandStack().isEmpty() && player.getOffHandStack().isEmpty() && player.isSneaking() && hand.equals(Hand.MAIN_HAND)) {
